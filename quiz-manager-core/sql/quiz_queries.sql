...
SELECT a.Q_TYPE , a.QUESTION, a.TOPICS, b.*, c.ANSWER AS CORRECT_ANSWER  FROM QUESTIONS AS a  JOIN STUDENTS_ANSWERS AS b ON a.id = b.Q_id JOIN MCQ_QUESTIONS AS c  ON a.id = c.Q_id where b.S_NAME LIKE 